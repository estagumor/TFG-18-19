...
describe("**Listing public projects**", function () {
    ...
    it('should return all public projects', (done) => {
        var project = new Project({ 'researchTeam': "persona1, persona2", 'workTeam': "persona2,persona3", 'hiredStaff': "persona4", 'title': "Proyecto prueba1", 'description': "Descripcion", 'leader': "persona1", 'reference': "666111666", 'scope': "REGIONAL", 'status': "ENVIADO", 'sponsor': "sponsor1", 'startDate': { year: 2017, month: 3, day: 5 }, 'endDate': { year: 2021, month: 3, day: 5 }, 'amount': 10000, 'relatedPublications': [], 'relatedTools': [] })
        var project1 = new Project({ 'researchTeam': "persona1, persona3", 'workTeam': "persona6", 'hiredStaff': "persona4", 'title': "Proyecto prueba2", 'description': "Descripcion", 'leader': "persona1", 'reference': "666111667", 'scope': "REGIONAL", 'status': "ENVIADO", 'sponsor': "sponsor1", 'startDate': { year: 2017, month: 3, day: 5 }, 'endDate': { year: 2021, month: 3, day: 5 }, 'amount': 10000, 'relatedPublications': [], 'relatedTools': [] })
        var project2 = new Project({ 'researchTeam': "persona1, persona4", 'workTeam': "persona7", 'hiredStaff': "persona4", 'title': "Proyecto prueba3", 'description': "Descripcion", 'leader': "persona1", 'reference': "666111668", 'scope': "REGIONAL", 'status': "ENVIADO", 'sponsor': "sponsor1", 'startDate': { year: 2017, month: 3, day: 5 }, 'endDate': { year: 2021, month: 3, day: 5 }, 'amount': 10000, 'relatedPublications': [], 'relatedTools': [] })
        var project3 = new Project({ 'researchTeam': "persona1, persona5", 'workTeam': "persona8", 'hiredStaff': "persona4", 'title': "Proyecto prueba4", 'description': "Descripcion", 'leader': "persona1", 'reference': "666111669", 'scope': "REGIONAL", 'status': "ENVIADO", 'sponsor': "sponsor1", 'startDate': { year: 2017, month: 3, day: 5 }, 'endDate': { year: 2021, month: 3, day: 5 }, 'amount': 10000, 'relatedPublications': [], 'relatedTools': [] })

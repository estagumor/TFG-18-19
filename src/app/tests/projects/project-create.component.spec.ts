...
describe("Project's component", () => {
  ...
  beforeEach(async(() => {
    ...
    TestBed.configureTestingModule({
      ...
      providers: [{provide: ComponentFixtureAutoDetect, useValue: true}, { provide: APP_BASE_HREF, useValue: '/' }, { provide: PersonService, useValue: personService }]
    })
      .compileComponents();
  ...
  //   expect(fixture.componentInstance.errors["badResearchers"].length > 0).toBeTruthy();
  // })
});